    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.CharField(blank=True, max_length=256, null=True, verbose_name='Информация')),
                ('username', models.CharField(max_length=150, unique=True, validators=[api.validations.validate_username], verbose_name='Имя пользователя')),
